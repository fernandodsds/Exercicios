...
public class Pilha2 <X> //LIFO
{

	private Object[] item;
	private int topo = -1;

	public Pilha2  (int capacidade) throws Exception
	{
	...
	public Pilha2 (Pilha2 <X> modelo) throws Exception
	{
		if (modelo==null)
	...
	public X getUmItem () throws Exception
	{
		...
		if(this.vazia())
    		throw new Exception("A Pilha2 esta vazia");
...
public boolean equals (Object obj)
{
	...
	Pilha2<X> param = null;
	try {
		param = new Pilha2<X>((Pilha2<X>)obj);
