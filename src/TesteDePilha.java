...
2) Nomes de classes e projetos
   ...
   ex: Fila, Programa, InputStreamReader
...
public class TesteDePilha {
	public static void main(String[] args) {
		...
		for (;;) {
			...
			try {
				f = new Pilha<String>(Integer.parseInt(teclado.readLine()));
				break;
		...
		char opcao;
		do {
			System.out.print("Opcao (G:guardar; R:recuperar; J:jogar fora; L:para listar; S:sair)? ");
			...
			case 'G':
				...
				try {
					...
					if (erro.getMessage().equals("Guardar oque?"))
						System.err.println("Faltou fornecer a informacao a ser guardada!");
					else
